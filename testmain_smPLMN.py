...
from smlp  import smthng_PlsMns_rx0
...
bbb,f1,f2 = bathy_smoothing.smoothing_PlusMinus_rx0(msk_rho, q, rx0_max,area)
...
st_time=time.perf_counter()
aaa=smthng_PlsMns_rx0(msk_rho,q,rx0_max,area)
ed_time=time.perf_counter()
